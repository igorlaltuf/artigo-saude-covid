...
#--- scripts das funções
source('Rscripts/01_datasus.R', encoding = 'UTF-8')
source('Rscripts/01_despesas_municipais_saude.R', encoding = 'UTF-8')
source('Rscripts/01_royalties.R', encoding = 'UTF-8')
...
Medicos.Muni(municipios) # quantidade de médicos por município

# incluir parallel processing (preciso fazer loops for no lugar do while)
# melhorar cores dos gráficos de barras, incluir label com valor